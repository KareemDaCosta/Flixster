...
console.log('moviesLoaded: ', moviesLoaded);
let numMovies = 0;
...
function loadMoreMovies(movieGridElement, movies, numIncrease) {
    for(let i = 0; i < numIncrease && numMovies < movies.length; i++) {
...
window.onload = function () {
    ...
    addEventListeners(loadMoreButton, searchBar);
  }